...
class GraphWin(tk.Canvas):
    ...
    def checkMouse(self):
        ...
        #self.update()  # BAM commented out for speed
...
class GraphicsObject:
    ...
    def getFill(self):
        """Returns the interior color. If the fill color is transparent, it
returns the empty string.  If the fill color is a hex string, it
returns r, g, b as integers between 0 and 255. If the fill color is a
color name string, it returns the name string.

        """
        val = self.canvas.itemcget(self.id, "fill")
        if len(val) == 0:
           return ""
        elif val[0] == '#' and len(val) == 7:
           return ( int('0x'+val[1:3],base=0), int('0x'+val[3:5],base=0) + int('0x'+val[5:7], base=0) )
        else:
           return val
    ...
    def getOutline(self):
        """Returns the outline color. If the fill color is transparent, it
returns the empty string.  If the fill color is a hex string, it
returns r, g, b as integers between 0 and 255. If the fill color is a
color name string, it returns the name string.

        """
        val = self.canvas.itemget(self.id, "outline")
        if len(val) == 0:
           return ""
        elif val[0] == '#' and len(val) == 7:
           return ( int('0x'+val[1:3]), int('0x'+val[3:5]) + int('0x'+val[5:7]) )
        else:
           return val
